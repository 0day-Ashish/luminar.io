        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pb-8">
          ...
          <div className="flex items-center gap-3">
            <a 
              ...
              className="w-9 h-9 bg-white rounded-lg border border-slate-300 flex items-center justify-center text-slate-650 hover:bg-slate-50 hover:border-slate-400 transition shadow-sm"
            >
