...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="sticky bottom-0 z-0 w-full bg-[#F2F0EF] pt-24 pb-16 px-4 sm:px-6 lg:px-12 border-t border-slate-200 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pb-8">
          ...
          <div className="flex items-center gap-3">
            <a 
              ...
              className="w-9 h-9 bg-white rounded-lg border border-slate-200 flex items-center justify-center text-slate-650 hover:bg-slate-50 hover:border-slate-300 transition shadow-sm"
            >
        ...
        <div className="w-full overflow-hidden select-none pointer-events-none pb-0 opacity-[0.03]">
          ...
          >
            <span className="text-[14vw] font-black font-cabinet tracking-tighter leading-none text-slate-900">
              Luminar
            </span>
            <svg viewBox="0 0 100 100" className="w-[10vw] h-[10vw] text-slate-900 shrink-0" fill="currentColor">
